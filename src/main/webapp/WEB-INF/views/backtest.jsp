    ...
    <div class="sidebar-body">
      ...
      <div class="p-grid">
        <div class="f-group">
          ...
          <input type="number" class="f-input" id="p_stopLossPct" value="2.3" step="0.1" min="0">
        </div>
        <div class="f-group">
          <label class="f-label">Take Profit %</label>
          <input type="number" class="f-input" id="p_takeProfitPct" value="3.2" step="0.1" min="0">
        </div>
        <div class="f-group">
          <label class="f-label">Trail Start %</label>
          <input type="number" class="f-input" id="p_trailStartPct" value="2.2" step="0.1" min="0">
        </div>
        <div class="f-group">
          <label class="f-label">Trail Drop %</label>
          <input type="number" class="f-input" id="p_trailDropPct" value="1.6" step="0.1" min="0">
        </div>
        <div class="f-group">
...
const PARAM_DEFAULTS = {
  pullbackMinScore:80, breakoutMinScore:78,
  ...
  stopLossPct:2.3, takeProfitPct:3.2, trailStartPct:2.2, trailDropPct:1.6,
